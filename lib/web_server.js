 ...
 * under the License.
 * baseon: https://github.com/apache/thrift/blob/80984289011604d43ec3282a3e8464fa08765f27/lib/nodejs/lib/thrift/web_server.js
 */
...
var MultiplexedProcessor = require('thrift/lib/nodejs/lib/thrift//multiplexed_processor').MultiplexedProcessor;
...
exports.createWebServer = function(options) {
  ...
  function processPost(request, response) {
    ...
    request.on('data', svc.transport.receiver(function(transportWithData) {
      ...
      try {
        svc.processor.process(input, output, request);
